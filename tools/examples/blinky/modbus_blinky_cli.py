...
Usage examples:
  python3 tools/examples/blinky/modbus_blinky_cli.py start
  python3 tools/examples/blinky/modbus_blinky_cli.py stop
  python3 tools/examples/blinky/modbus_blinky_cli.py status
  python3 tools/examples/blinky/modbus_blinky_cli.py period 250000
  python3 tools/examples/blinky/modbus_blinky_cli.py period 100000 500000
  python3 tools/examples/blinky/modbus_blinky_cli.py toggle
  python3 tools/examples/blinky/modbus_blinky_cli.py interactive
