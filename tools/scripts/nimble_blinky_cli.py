...
Usage:
  python3 nimble_blinky_cli.py start         # Start blinking
  python3 nimble_blinky_cli.py stop          # Stop blinking
  python3 nimble_blinky_cli.py status        # Show current state
  python3 nimble_blinky_cli.py period <us>   # Set dwell (same for on/off)
  python3 nimble_blinky_cli.py period <off_us> <on_us>
  python3 nimble_blinky_cli.py toggle        # Toggle start/stop
  python3 nimble_blinky_cli.py interactive   # Interactive shell
  python3 nimble_blinky_cli.py scan          # List BLE devices nearby
